<?php namespace App\Http\Controllers;
	...
	class AdminCustomersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Phone Number','name'=>'phone','type'=>'number','validation'=>'required|numeric','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Other Phone Number','name'=>'phone_other','type'=>'number','validation'=>'required|numeric','width'=>'col-sm-10'];
